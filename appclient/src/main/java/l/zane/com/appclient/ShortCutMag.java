...
/**
 * Created by shizhang on 2017/9/2.
 */

public class ShortCutMag {
    /**
     ...
     * <uses-permission android:name="com.android.launcher.permission.INSTALL_SHORTCUT"/>
        使用 sendBroadcast(getShortcutToDesktopIntent(MainActivity.this));
     */
    ...
    public static Intent getShortcutToDesktopIntent(Context context) {
        ...
        // 设置名字
        shortcut.putExtra(Intent.EXTRA_SHORTCUT_NAME,"哈哈哈");
        // 设置图标
